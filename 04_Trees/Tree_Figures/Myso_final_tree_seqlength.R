...
########
mytree <- read.tree(file = "loci_gt07_n200_myoso_bs20_astral_root.treefile")
mytree$tip.label <- gsub("_nomerge","", mytree$tip.label)
mytree$tip.label <- gsub("livi_SS_livi2", "lyel_SS_livi2", mytree$tip.label)
mytree$tip.label <- gsub("livi_SS_livi3", "lyel_SS_livi3", mytree$tip.label)

T0 = ggtree(mytree, branch.length = "none") +  
...
mycha <- read.csv("Myosotis_characters_by_individuals2024NEW.csv", header = T,  na.strings=c("NA"," ")) %>% 
  filter(individual %in% mytree$tip.label)
...
pdf("Myso_x353_fivebars_withname.pdf", width = 15, height = 22)
T5 +   geom_tiplab(align = TRUE, aes(label = "")) 
dev.off()

T6 <- collapse(T5, 516, 'mixed', fill='grey70', alpha=.4) %>% 
  collapse(463, 'mixed', fill='grey70', alpha=.4) %>%
  collapse(448, 'mixed', fill='grey70', alpha=.4) %>%
  collapse(426, 'mixed', fill='grey70', alpha=.4) %>%
  collapse(407, 'mixed', fill='grey70', alpha=.4) %>%
  collapse(329, 'mixed', fill='grey70', alpha=.4) %>%
  collapse(306, 'mixed', fill='grey70', alpha=.4) %>%
  collapse(301, 'mixed', fill='grey70', alpha=.4) %>%
  collapse(297, 'mixed', fill='grey70', alpha=.4) %>%
  collapse(294, 'mixed', fill='grey70', alpha=.4)




pdf("Myso_x353_fivebars2.pdf", width = 15, height = 22)
T6 + annotate("segment", x = 22, xend = 33.7, y = 5, yend = 5,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 25, yend = 25,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 28, yend = 28,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 31, yend = 31,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 34, yend = 34,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 37, yend = 37,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 40, yend = 40,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 43, yend = 43,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 46, yend = 46,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 49, yend = 49,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 52, yend = 52,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 55, yend = 55,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 58, yend = 58,colour = "black", linetype = "dashed")+ 
  annotate("segment", x = 22, xend = 33.7, y = 61, yend = 61,colour = "black", linetype = "dashed")
dev.off()
